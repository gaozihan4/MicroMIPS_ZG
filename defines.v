...
`define InstMemNum      131071      // ROM capacity 128 kB
`define InstMemNumLog2  17          // ROM actual Addr Bus width
...
//************ Regfile Related ****************************
`define RegAddrBus      4:0         // Regfile Addr Bus width
`define RegBus          31:0        // Regfile Data Bus width
`define RegWidth        32          // Reg width
`define DoubleRegWidth  64          // Double reg width
`define DoubleRegBus    63:0        // Double width of data bus
`define RegNum          32          // Number of regs
`define RegNumLog2      5           // reg addr bus width
